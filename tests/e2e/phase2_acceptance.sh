...
# 1.1: system.capabilities returns 37
...
# 3.3: MCP system.capabilities returns 37
...
check "Schema validation: 101 fixtures pass" test "$schema_count" = "101"
